...
export class MessagePropertyDecorator implements MessageDecorator {
  ...
  decoratedMessage(message: Message): { op: string; data: object } {
    ...
    if(message.data()[this._propertyName] !== undefined){
      decoratedMessage.data[this._propertyName] = this._propertyValue;
    }
